...
public class BasicEdgeOrchestrator extends EdgeOrchestrator {
	...
	@Override
	public void TrainAgent(Task task, double s){}

	@Override
	public  CFNState GetFeaturesForAgent(Task task){return null;}

	@Override
	public List<DefaultEdge> getRouteToOffload(Task task) {
		List<DefaultEdge> result = null;
